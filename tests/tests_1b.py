...
def test_float_arithmetic():
    assert simple_calculator("add", 1.5, 2.5) == 4
    assert simple_calculator("subtract", 0.5, 2.5) == -2
    assert simple_calculator("multiply", 2.5, 2.5) == 6.25
    assert simple_calculator("divide", 15.5, 0.25) == 62
